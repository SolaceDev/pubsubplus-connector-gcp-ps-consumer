[![Actions Status](https://github.com/SolaceDev/pubsubplus-connector-gcp-ps-consumer/workflows/build/badge.svg?branch=BadgeTest)](https://github.com/SolaceDev/pubsubplus-connector-gcp-ps-consumer/actions?query=workflow%3Abuild+branch%3ABadgeTest)
